    ...
    try {
      ...
      if (error.code) {
        if (error.code === "auth/account-exists-with-different-credential") {
          setError(
            "Account exists with different provider. Try another sign-in method."
          );
        } else {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='generate branding snipeet, brand name, keywords, and logo for your product'
        />
        <meta name='viewport' content='width=device-width, initial-scale=1' />
        <link rel='icon' href='/favicon.ico' />
      </Head>
      <div className='min-h-screen flex flex-col justify-center items-center bg-sky-950'>
        <div className='m-auto p-2 container max-w-md bg-gray-50 rounded-md text-black'>
